...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "منصة احترافية لصيانة الهواتف: شروحات، ملفات، أدوات وأسئلة وأجوبة.",
      },
      { name: "author", content: "RONI TECH X" },
      { property: "og:title", content: "RONI TECH X | مركز التقنية والصيانة" },
      {
        property: "og:description",
        content: "شروحات صيانة الهواتف، تعريفات، أدوات وملفات فلاش.",
      },
